                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    <td>{{ sl + 1 }}</td>
                                    <td style="text-align:left"> <strong>{{ product.Product_Name }}  </strong>
                                        <div  style="text-align:left" v-for="engine in product.engines">
                                            Eng No:  {{ engine.EngineNo }} -
                                            Ch No:  {{ engine.chassisNo }}<br>
                                        </div>
                                    </td>
    ...
    methods:{
        getPurchase(){
            axios.post('/get_purchases', {purchaseId: this.purchase_id}).then(res=>{
                ...
                this.engine = res.data.purchaseEngineDetailes;
