            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    <div class="col-xs-7">
                        ...
                        <strong>Father Name:</strong> {{ sales.owner_name }}<br>
                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    <td>{{ sl + 1 }}</td>
                                    <td align="left"><strong>{{ product.Product_Name }}</strong>
                                    <div>
                                    Eng No:  {{ product.EngineNo }} <br>
                                    Ch No: {{ product.chassisNo }}<br>
                                    </div>
                                    </td>
				...
				printWindow.document.write(`
                    ...
                    <body>
                        <div class="container">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="row" style="height:185px">
                                                <div class="col-xs-2" style=" display:none"><img src="/uploads/company_profile_thum/${this.currentBranch.Company_Logo_org}" alt="Logo" style="height:80px;" /></div>
                                                <div class="col-xs-10" style="padding-top:20px; display:none">
                                                    <strong style="font-size:18px;">${this.currentBranch.Company_Name}</strong><br>
                                                    <p style="white-space:pre-line;">${this.currentBranch.Repot_Heading}</p>
                                                </div>
                                            </div>
                            ...
                            <div style="position:fixed;left:0;bottom:15px;width:100%; display:none;">
