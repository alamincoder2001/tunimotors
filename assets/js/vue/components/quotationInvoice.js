                    ...
                    <div class="col-xs-6 col-xs-offset-6">
                        <table _t92sadbc2>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right">{{ quotation.registrationFree }}</td>
                            </tr>
                            <tr>
            ...
            printWindow.document.write(`
                ...
                <body>
                    <div class="container" style="margin-top:200px">
                        <div class="row">
                            <div class="col-xs-2" style="display:none"><img src="/uploads/company_profile_thum/${this.companyProfile.Company_Logo_thum}" alt="Logo" style="height:80px;" /></div>
                    ...
                    <div class="container" style="position:fixed;bottom:50px;width:100%;">
                        ...
                        <div class="row" style="font-size:12px; display:none">
                            <div class="col-xs-6">
