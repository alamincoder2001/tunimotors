        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="sales">
                    ...
                    <li><input type="checkbox" class="access" value="due_reminder" v-model="access"> Due Reminder</li>
                    <li><input type="checkbox" class="access" value="pre_booking" v-model="access"> PreBooking List</li>
                </ul>
            </div>
        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="salesReports">
                    ...
                    <li><input type="checkbox" class="access" value="pre_booking_report" v-model="access"> PreBooking Report</li>
                </ul>
            </div>
            ...
            <div class="group">
                ...
                <ul ref="accountsReports">
                    ...
                    <li><input type="checkbox" class="access" value="blanch_statement" v-model="access"> balance Statement</li>
                    <li><input type="checkbox" class="access" value="registration_statement" v-model="access"> Registration Statement</li>
                </ul>
            </div>
        </div>
        <div class="col-md-3">
