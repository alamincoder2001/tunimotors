							...
							<tbody>
								...
								<template>
									...
									<tr style="display:none;">
										<th></th>
										<th>
										{{ totalProfitOrLoss = ((parseFloat(totalProfit) + parseFloat(otherIncomeExpense.income) + parseFloat(otherIncomeExpense.reg_profit) + parseFloat(otherIncomeExpense.vat)) - 
								...
								<template >
									<tr>
										<th class="sub-heading">Loss  <span style="color:red;">(Not Calculated)</span></th>
										<th class="sub-value" style="display:none;" v-bind:style="{display: totalProfitOrLoss > 0  ? 'none' : ''}"	>
										{{ parseFloat(totalProfitOrLoss).toFixed(2) }}
										</th>
									</tr>
								</template>
					...
					<div style="width:50%;border:1px solid black;border-left:none;position:relative;">
						<table class="day-book-table">
							...
							<tbody>
								...
								<template >
									<tr>
										<th class="sub-heading">Profit <span style="color:red;">(Not Calculated)</span></th>
										<th class="sub-value" style="display:none;" v-bind:style="{display: totalProfitOrLoss < 0  ? 'none' : ''}"	>
										{{ parseFloat(totalProfitOrLoss).toFixed(2) }}
										</th>
									</tr>
