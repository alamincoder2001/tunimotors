								...
								<table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
									<tr>
	                                   ...
	                                   <tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 control-label no-padding-right">Registration </label>
												<div class="col-sm-12">
													<input type="number" class="form-control" v-model="quotation.registration"  v-on:input="calculateTotal"/>
												</div>
											</div>
										</td>
									</tr>
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-7">
													<input type="number" id="vat" class="form-control" v-model="quotation.vat"  v-on:input="calculateTotal"/>
												</div>
											</div>
										</td>
									</tr>
	...
	new Vue({
		...
		methods:{
			...
			calculateTotal(){
				...
				this.quotation.total = ((parseFloat(this.quotation.subTotal) + parseFloat(this.quotation.vat) + parseFloat(this.quotation.registration)) - parseFloat(this.quotation.discount)).toFixed(2);
			...
			getQuotations(){
				axios.post('/get_quotations', {quotationId: this.quotation.quotationId}).then(res=>{
					...
					this.quotation.registration = quotation.registrationFree;
