...
<div id="customerPayment">
	<div class="row" style="border-bottom: 1px solid #ccc;padding-bottom: 15px;margin-bottom: 15px;">
		<div class="col-md-12">
				...
				<div class="row">
					...
					<div class="col-md-5">
						...
						<div class="form-group">
							...
							<label class="col-md-1"></label>
							<div class="col-md-7">
								<label for="pre_booking" @click="modalCheck"><input type="checkbox" id="pre_booking" > Pre Booking</label>
							</div>
						</div>
						<div class="form-group">
			...
			<!-- Modal -->
			<div v-if="showModal" class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel">Pre Booking Form</h4>
						</div>
							...
							<div class="modal-body">
								<div class="form-group row">
									<div class="col-md-6">
										...
										<v-select v-bind:options="customers" v-model="selectedCustomer" label="display_name" v-if="customers.length > 0"></v-select>
									</div>
									<div class="col-md-6">
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										...
										<input type="text" v-model="selectedProduct.Product_SellingPrice" class="form-control">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-6">
										<label for="">Advance</label>
										<input id="Advance" type="text" v-model="prebooking.advance" class="form-control">
									</div>
									<div class="col-md-6">
										<label for="">Delivery Date</label>
										<input type="date" v-model="prebooking.delivery_date" class="form-control">
									</div>
								</div>
							</div>
	...
	new Vue({
		...
		methods:{
			modalCheck(){
				$('#myModal').modal('show');
				this.showModal = true;
				this.prebooking.advance = this.payment.CPayment_amount;
			},
			getCustomerPayments(){
				let data = {
			...
			savePreBooking() {
				this.prebooking.customer_id = this.selectedCustomer.Customer_SlNo;
				this.prebooking.mobile = this.selectedCustomer.Customer_Mobile;
				this.prebooking.product_id = this.selectedProduct.Product_SlNo;
				this.prebooking.price = this.selectedProduct.Product_SellingPrice;

				axios.post('/save_pre_booking', this.prebooking).then(res => {
					let r = res.data;
					if(r.success) {
						alert(r.message);
