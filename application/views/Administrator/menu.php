...
<?php } elseif ($module == 'SalesModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("pre_booking", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>pre_booking">
					<i class="menu-icon fa fa-plus-square"></i>
					<span class="menu-text"> PreBooking List </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (
			...
			|| array_search("due_reminder", $access) > -1
			|| array_search("pre_booking_report", $access) > -1
			|| isset($CheckSuperAdmin) || isset($CheckAdmin)
		) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>" class="dropdown-toggle">
				...
				<ul class="submenu">
					...
					<?php if (array_search("due_reminder", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>due_reminder">
								<i class="menu-icon fa fa-caret-right"></i>
								Due Reminder
							</a>
							<b class="arrow"></b>
					...
					<?php if (array_search("pre_booking_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>pre_booking_report">
								<i class="menu-icon fa fa-caret-right"></i>
								PreBooking Report
							</a>
							<b class="arrow"></b>
...
<?php } elseif ($module == 'AccountsModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("registration_statement", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li>
				<a href="<?php echo base_url(); ?>registration_statement">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text"> Reg. Statement </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (
			...
			<li class="">
				...
				<ul class="submenu">
					...
					<?php endif; ?>
					<?php if (array_search("blanch_statement", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
					<li class="">
						<a href="<?php echo base_url(); ?>blanch_statement">
							<i class="menu-icon fa fa-money"></i>
							<span class="menu-text">Balance Statement</span>
						</a>
						<b class="arrow"></b>
					</li>
				<?php endif; ?>
