                ...
                <table class="table table-bordered table-condensed">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td style="text-align:right;font-weight:bold;">{{ TotalIn = parseFloat(transactions.reduce((p, c) => { return p + parseFloat(c.In_Amount) }, 0)).toFixed(2) }}</td>
                            <td style="text-align:right;font-weight:bold;">{{ ToatalOut = parseFloat(transactions.reduce((p, c) => { return p + parseFloat(c.Out_Amount) }, 0)).toFixed(2) }}</td>
                        </tr>
                        <tr>
                            <td colspan="5" style="text-align:right;font-weight:bold;"> Balance </td>
                            <td colspan="2" style="text-align:right;font-weight:bold;">{{ parseFloat(TotalIn - ToatalOut).toFixed(2) }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
