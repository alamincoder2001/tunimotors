				...
				<div class="navbar-header pull-left">
					<a href="<?php echo base_url(); ?>" class="navbar-brand">
						<small>
							...
							<!--Enterprise Resource Planning--><?php //echo $companyInfo->Company_Name;?> Tuni Motors <span style="color:#000;font-weight:700;letter-spacing:1px;font-size:16px;"> <?php //echo $this->session->userdata('Brunch_name'); ?> </span>
						</small>
					</a>
				</div>
