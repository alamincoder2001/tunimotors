			...
			<div class="table-responsive" id="reportTable">
				<table id="table1">
					...
					<tfoot style="display:none;font-weight:bold;background-color:#e9dcdc;" v-bind:style="{display: reportData.length > 0 ? '' : 'none'}">
						...
						<tr>
							<td colspan="4" style="text-align:right;">Total Registration Profit (+)</td>
							<td colspan="2"></td>
							<td style="text-align:right;">{{ otherIncomeExpense.reg_profit | decimal }}</td>
						</tr>
						<tr>
							<td colspan="4" style="text-align:right;">Vat (+)</td>
							<td colspan="2"></td>
							<td style="text-align:right;">{{ otherIncomeExpense.vat | decimal }}</td>
						</tr>
						...
						<tr>
							...
							<td colspan="2"></td>
							<td style="text-align:right;">
								{{  ((parseFloat(totalProfit) + parseFloat(otherIncomeExpense.income) + parseFloat(otherIncomeExpense.reg_profit) + parseFloat(otherIncomeExpense.vat)) - 
